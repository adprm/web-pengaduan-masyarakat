    ...
    <div class="row">
            ...
            <div class="card border-left-primary shadow h-100 py-2">
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">Total Wewenang Akses</div>
                ...
                <small><a class="ml-3" href="<?= base_url('admin/role'); ?>">Lihat &rarr;</a></small>
            </div>
        </div>
        <div class="col-xl-3 col-md-6 mb-4">
        ...
        <div class="col-xl-3 col-md-6 mb-4">
            <div class="card border-left-info shadow h-100 py-2">
                ...
                <small><a class="ml-3" href="<?= base_url('menu'); ?>">Lihat &rarr;</a></small>
            </div>
        </div>
        <div class="col-xl-3 col-md-6 mb-4">
            <div class="card border-left-danger shadow h-100 py-2">
                ...
                <small><a class="ml-3" href="<?= base_url('menu/submenu'); ?>">Lihat &rarr;</a></small>
            </div>
        </div>
        <div class="col-xl-3 col-md-6 mb-4">
