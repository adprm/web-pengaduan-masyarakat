            ...
            <div class="p-5">
              ...
              <form class="user">
                <div class="form-group">
                  <input type="email" class="form-control form-control-user" id="name" placeholder="Nama lengkap">
                </div>
                <div class="form-group">
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-6">
                    <input type="password" class="form-control form-control-user" id="exampleRepeatPassword" placeholder="Ulangi kata sandi">
                  </div>
                </div>
